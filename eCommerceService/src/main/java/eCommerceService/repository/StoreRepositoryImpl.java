...
import ecommerceservice.dataaccesslayer.tables.records.StoreCategoryMapRecord;
...
public class StoreRepositoryImpl implements StoreRepository {
  ...
  private static final StoreCategory STORE_CATEGORY = StoreCategory.STORE_CATEGORY;
  ...
  @Override
  public void createStore(@NonNull final eCommerceService.model.Store store) {
  ...
  @Override
  public void updateStore(@NonNull final eCommerceService.model.Store store) {
  ...
  @Override
  public List<eCommerceService.model.Store> findStores(
  ...
  @Override
  public Optional<eCommerceService.model.Store> getStoreInfo(@NonNull String uniqueStoreName) {
    ...
    List<eCommerceService.model.Store> stores = buildStoreListWithReturnedDatabaseRecords(records);
  ...
  @Override
  public List<eCommerceService.model.StoreCategory> getAllStoreCategories() {
    Result<Record> records =
        jooqDslContext
  ...
  private List<eCommerceService.model.Store> buildStoreListWithReturnedDatabaseRecords (
  ...
  private void addLocationForStore(@NonNull final eCommerceService.model.@NonNull Store store,
  ...
  private void addCategoriesForStore(
      @NonNull final eCommerceService.model.Store store, @NonNull StoreRecord storeRecord) {
    if (!CollectionUtils.isNullOrEmpty(store.getStoreCategories())) {
      Map<String, eCommerceService.model.StoreCategory> allStoreCategories =
