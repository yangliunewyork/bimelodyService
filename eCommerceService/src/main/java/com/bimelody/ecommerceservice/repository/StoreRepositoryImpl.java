...
/**
 * Implementation for Store repository. Used for retrieval, and search Store information.
 */
@Slf4j
@Repository
@AllArgsConstructor
public class StoreRepositoryImpl implements StoreRepository {
  ...
  public void updateStore(@NonNull final com.bimelody.ecommerceservice.model.Store store) {
    ...
    if (records.size() > 1) {
      throw new IllegalStateException(
          "More than 1 records are found for storeIdentifier= " + store.getUniqueStoreName()
              + "in database!");
    }
  ...
  @Override
  public Optional<com.bimelody.ecommerceservice.model.Store> getStoreInfo(
      @NonNull String uniqueStoreName) {
    ...
    List<com.bimelody.ecommerceservice.model.Store> stores =
        buildStoreListWithReturnedDatabaseRecords(records);
  ...
  private void addCategoriesForStore(
      @NonNull final com.bimelody.ecommerceservice.model.Store store,
      @NonNull StoreRecord storeRecord) {
