...
public class ProductServiceImpl implements ProductService {
  ...
  @Override
  public List<Product> searchProductsInStore(String storeIdentifier, String productCategory,
                                             int pageNum, int pageSize) {
    return productRepository.searchProductsInStore(storeIdentifier, productCategory, pageNum,
        pageSize);
  }

  @Override
  public Optional<Product> findProductInfoFromStore(String storeIdentifier,
